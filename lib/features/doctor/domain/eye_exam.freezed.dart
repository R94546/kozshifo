...
mixin _$EyeExam {
 ...
 String? get odVa; String? get osVa; String? get odSph; String? get osSph; String? get odCyl; String? get osCyl; int? get odAxis; int? get osAxis; String? get odVaCc; String? get osVaCc;// Tonometry, mmHg
...
class _EyeExam extends EyeExam {
  const _EyeExam({required this.id, required this.visitId, required this.patientId, this.doctorId, this.examDate, this.complaints, this.anamnesis, this.odVa, this.osVa, this.odSph, this.osSph, this.odCyl, this.osCyl, this.odAxis, this.osAxis, this.odVaCc, this.osVaCc, this.iopOd, this.iopOs, this.orbit, this.eyeball, this.eyelids, this.conjunctiva, this.lacrimal, this.cornea, this.anteriorChamber, this.iris, this.pupil, this.lens, this.vitreous, this.fundus, this.abScanNote, this.diagnosis, this.icd10, this.recommendations, this.createdAt, this.updatedAt}): super._();
